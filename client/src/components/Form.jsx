...
// REGISTRATION VALIDATION SCHEMA YUP
...
// LOGIN VALIDATION SCHEMA YUP 
const loginSchema = yup.object().shape({
  email: yup.string().email('invalid email').required('required'),
  password: yup.string().required('required')
})

// RGISTER FORM INITIAL STATE 
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    // CONSIDERATION FOR FORM VALUE WITH IMAGE 
  ...
  const login = async (values, onSubmitProps) => {
    ...
    // SET USER AND TOKEN AFTER LOGGING IN 
    if (loggedIn) {
      dispatch(
        setLogin({
          user: loggedIn.user,
  ...
  return (
    <Formik
      ...
      initialValues={isLogin ? initialValuesLoginForm : initialValuesRegisterForm}
